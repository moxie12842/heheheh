...
local del2 = 0;
function onCreate()
    makeLuaSprite('sun2', 'sun2', -2700, -1900);
    setScrollFactor('sun2', 0.7, 0.7);
    scaleObject('sun2', 2, 2);
    addLuaSprite('sun2', false)

    makeLuaSprite('building', 'building', -2700, -1800);
    setScrollFactor('building', 1, 1);
    scaleObject('building', 2, 2);
    addLuaSprite('building', false)

    makeLuaSprite('floor2', 'floor2', -2700, -1799);
